...
<body>
	...
	<form id="myForm" name="myForm" action="MainPageAdmEditComision" method="get">	
		<div class="content-container">
		  	<div class="container-fluid">
			    ...
			    <div class="col-md-12 order-md-1">
  				<h1><Strong>Edicion de Comision numero <%=C.getIdComision() %></Strong></h1>
  				...
  				<div class="row">
			        ...
			        <input name= "Numero" type="number" class="form-control" id="Numero" min="0" value="<%=C.getIdComision() %>" required readonly
			        	title = "El Tamaño minimo es de 4 y el maximo de 20" style="-moz-appearance:textfield;-webkit-appearance: none;">
			        ...
			        <input name= "alumMax" type="number" class="form-control" id="alumMax"  min="0" value="<%=C.getCantAlumnosMax() %>" required
		        ...
		        <div class="row">
		        	<div class="col-md-6 mb-3">
				        ...
				        <option value="<%=C.getIdMateria() %>"><%=DM.getOne(C.getIdMateria()).getNombre() %></option>
				       	</select>
					        <div class="invalid-feedback">
...
$('select option[value="<%=C.getIdDocente()%>"]').attr("selected",true);

<%if(C.getTurno().toString().equals("Mañana")){%>
	$('select option[value="Manana"]').attr("selected",true);
<%}else{%>
	$('select option[value="<%=C.getTurno()%>"]').attr("selected",true);
<%}%>
