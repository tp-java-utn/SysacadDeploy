...
<meta charset="utf-8">
    ...
    <%
    	Mesa M = (Mesa)session.getAttribute("Mesa");
...
<body>
	...
	<form id="myForm" name="myForm" action="MainPageAdmEditMesa" method="get">	
			    ...
			    <div class="col-md-12 order-md-1">
	  				...
	  				<div class="row">
					    ...
					    <div class="col-md-6 mb-3">
			      		<label for="Salon">Salon</label>
		      	  		<input name= "Salon" type="number" class="form-control" id="Salon" min="0" maxlength="20" value="<%=M.getSalon() %>"
				        	title = "El Tamaño minimo es de 3 y el maximo de 20">
					    </div> 
          			...
          			<div class="row">
			      		...
			      		<label for="Horario">Horario</label>
		      	  		<input name= "Horario" type="number" class="form-control" id="Horario" min="0" max="24" value="<%=M.getHorario() %>" maxlength="20"
				        	title = "El Tamaño minimo es de 4 y el maximo de 20">
					    </div> 
				        
				        <div class="col-md-6 mb-3">
			      		<label for="Fecha">Fecha</label>
		      	  		<input name= "Fecha" type="date" class="form-control" id="Fecha" min="0" maxlength="20" value="<%=M.getFecha() %>"
				        	title = "El Tamaño minimo es de 4 y el maximo de 20">
					    </div> 
...
$('#Materia').append($('<option>', {
    value: <%=Ma.getIdMateria()%>,
    text: '<%=Ma.getNombre()%>'
}));
<%}%>

$('select option[value="<%=M.getIdMateria()%>"]').attr("selected",true);
</script>
