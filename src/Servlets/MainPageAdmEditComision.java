 ...
 */
@WebServlet("/MainPageAdmEditComision")
public class MainPageAdmEditComision extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MainPageAdmEditComision() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(idComision != 0 && idMateria != 0 && idDocente != 0 && alumMax != 0 && turno != null )
		{
			...
			{				
				...
				DC.updateComision(idComision, idMateria, idDocente, alumMax, turnos.valueOf(turno));
