 ...
 */
@WebServlet("/MainPageAdmEditMesa")
public class MainPageAdmEditMesa extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MainPageAdmEditMesa() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Mesa M = (Mesa)request.getSession(false).getAttribute("Mesa");
		...
		if(salon != 0 && horario != 0 && fecha != null && materia != 0 )
		{
			...
			{	
				DM.updateMesa(idMesa, materia, horario, salon, fecha);
